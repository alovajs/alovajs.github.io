...
// EXTERNAL MODULE: ./node_modules/@codesandbox/sandpack-client/dist/types-36e5ec0d.mjs
var types_36e5ec0d = __webpack_require__(58672);
...
var base_80a1f760 = __webpack_require__(32308);
// EXTERNAL MODULE: ./node_modules/@codesandbox/sandpack-client/dist/consoleHook-7a68abbd.mjs
var consoleHook_7a68abbd = __webpack_require__(70224);
// EXTERNAL MODULE: ./node_modules/outvariant/lib/index.mjs
var lib = __webpack_require__(95002);
// EXTERNAL MODULE: ./node_modules/dequal/dist/index.mjs
var dist = __webpack_require__(38471);
...
function loadPreviewIframe(iframe, url) {
    return (0,types_36e5ec0d._)(this, void 0, void 0, function () {
        ...
        return (0,types_36e5ec0d.a)(this, function (_a) {
            ...
            (0,types_36e5ec0d.n)(contentWindow, "Failed to await preview iframe: no content window found");
            TIME_OUT = 90000;
            MAX_MANY_TIRES = 20;
            tries = 0;
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    var triesToSetUrl = function () {
                        ...
                        if (tries >= MAX_MANY_TIRES) {
                            reject((0,types_36e5ec0d.c)("Could not able to connect to preview."));
                            return;
                        }
...
var scripts = [
    ...
    {
        code: "function consoleHook({ scope }) {" + consoleHook_7a68abbd.c + "\n};",
        id: "consoleHook"
    },
];
...
var SandpackNode = /** @class */ (function (_super) {
    ...
    function SandpackNode(selector, sandboxInfo, options) {
        if (options === void 0) { options = {}; }
        var _this = _super.call(this, selector, sandboxInfo, (0,types_36e5ec0d.h)((0,types_36e5ec0d.h)({}, options), { bundlerURL: options.bundlerURL })) || this;
        _this._modulesCache = new Map();
        _this.messageChannelId = (0,consoleHook_7a68abbd.g)();
        _this._initPromise = null;
        _this.emitter = new consoleHook_7a68abbd.E();
        // Assign iframes
                ...
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        this.dispatch({
                            ...
                            title: (0,consoleHook_7a68abbd.a)(err_1)
                        });
    ...
    SandpackNode.prototype.createShellProcessFromTask = function (files) {
        return (0,types_36e5ec0d._)(this, void 0, void 0, function () {
            ...
            return (0,types_36e5ec0d.a)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        packageJsonContent = (0,consoleHook_7a68abbd.r)(files["/package.json"]);
                        this.emulatorCommand = (0,consoleHook_7a68abbd.b)(packageJsonContent);
                        ...
                        return [4 /*yield*/, this.emulatorShellProcess.on("exit", function (exitCode) {
                                _this.dispatch({
                                    ...
                                    action: "notification",
                                    notificationType: "error",
                                    title: (0,types_36e5ec0d.c)("Error: process.exit(" + exitCode + ") called.")
                                });
                            })];
                    case 1:
                        // Shell listeners
                        ...
                        return [4 /*yield*/, this.emulatorShellProcess.on("progress", function (data) {
                                ...
                                if (data.state === "command_running" ||
                                    ...
                                    _this.dispatch({
                                        type: "shell/progress",
                                        data: (0,types_36e5ec0d.h)((0,types_36e5ec0d.h)({}, data), { command: [
    ...
    SandpackNode.prototype.manageIframes = function (selector) {
        ...
        if (typeof selector === "string") {
            ...
            (0,types_36e5ec0d.n)(element, "The element '" + selector + "' was not found");
        ...
        (0,types_36e5ec0d.n)(this.iframe.parentNode, "The given iframe does not have a parent.");
        /**
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.emulator.fs.watch(["*"], [
                                ...
                                ".config",
                                ".vuepress",
                            ], function (message) { return (0,types_36e5ec0d._)(_this, void 0, void 0, function () {
                                ...
                                return (0,types_36e5ec0d.a)(this, function (_b) {
                                    switch (_b.label) {
                                        ...
                                        case 4:
                                            ...
                                            this._modulesCache.set(event.path, (0,consoleHook_7a68abbd.w)(content));
                                            return [3 /*break*/, 9];
                                        case 5:
                                            this.dispatch({
                                                type: "fs/remove",
                                        ...
                                        case 7:
                                            ...
                                            this._modulesCache.set(event.newPath, (0,consoleHook_7a68abbd.w)(newContent));
                                            return [3 /*break*/, 9];
                                        ...
                                        case 10:
                                            ...
                                            this.dispatch({
                                                ...
                                                action: "notification",
                                                notificationType: "error",
                                                title: (0,consoleHook_7a68abbd.a)(err_2)
                                            });
                                            return [3 /*break*/, 11];
    ...
    SandpackNode.prototype.updateSandbox = function (setup) {
        var _this = this;
        var _a;
        var modules = (0,consoleHook_7a68abbd.f)(setup.files);
        /**
         * Update file changes
         */
        if (((_a = this.emulatorShellProcess) === null || _a === void 0 ? void 0 : _a.state) === "running") {
            Object.entries(modules).forEach(function (_a) {
                ...
                if (!_this._modulesCache.get(key) ||
                    (0,consoleHook_7a68abbd.r)(value) !== (0,consoleHook_7a68abbd.r)(_this._modulesCache.get(key))) {
        ...
        Object.entries(modules).forEach(function (_a) {
            var key = _a[0], value = _a[1];
            _this._modulesCache.set(key, (0,consoleHook_7a68abbd.w)(value));
        });
    };
...
/* harmony export */ });
/* harmony import */ var outvariant__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(95002);
/* harmony import */ var _types_36e5ec0d_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(58672);
...
var findStartScriptPackageJson = function (packageJson) {
    ...
    (0,outvariant__WEBPACK_IMPORTED_MODULE_0__/* .invariant */ .kG)(scripts, "Failed to start. Please provide a `start` or `dev` script on the package.json");
