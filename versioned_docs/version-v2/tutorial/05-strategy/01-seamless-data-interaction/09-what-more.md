...
In the previous [data compensation](/v2/tutorial/strategy/seamless-data-interaction/data-compensation), we used [filterSilentMethods](/v2/tutorial/strategy/seamless-data-interaction/data-compensation#filtersilentmethods) to find the silentMethod of the specified queue instance, it will return all matching silentMethod instances, here are two more ways to find the queue:

#### Find a silentMethod instance

Use `getSilentMethod` to query the first matching silentMethod instance, the usage is the same as [filterSilentMethods](/v2/tutorial/strategy/seamless-data-interaction/data-compensation#filtersilentmethods).
