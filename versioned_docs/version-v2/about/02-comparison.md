...
alova provides you with [multiple high-performance request strategy modules](/v2/tutorial/strategy). You can use different modules according to different request scenarios, which axios does not have.
