...
我们提供了一个[笔记应用示例](/next/tutorial/example/react/silent-submit-notes)，你可以进入体验。
...
我们提供了一个[设置页示例](/next/tutorial/example/svelte/silent-submit-setting)，你可以进入体验。
...
我们提供了一个[简单列表页示例](/next/tutorial/example/vue/silent-submit-simple-list)，你可以进入体验。
...
- [基础学习](/next/tutorial/getting-started/quick-start)
...
<!-- 我们提供了一个[预加载的示例](/next/tutorial/example/vue/prefetch)，你可以进入体验。 -->
