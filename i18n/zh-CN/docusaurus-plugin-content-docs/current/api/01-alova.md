...
| localCache     | object                      | 本地缓存配置，默认 GET 有 5000ms 缓存，[查看详情](/next/tutorial/cache/mode)                     |
...
| localCache    | LocalCacheConfig | 响应缓存时间，[查看详情](/next/tutorial/cache/mode)                                                                                                                                                                                                                                                              |
| hitSource     | string           | 打击源方法实例，当源方法实例请求成功时，当前方法实例的缓存将被失效，[查看详情](/next/tutorial/cache/auto-invalidate)                                                                                                                                                                                             |
| transformData | function         | 转换响应数据，[查看详情](/next/tutorial/getting-started/basic/method)                                                                                                                                                                                                                                            |
