...
| shareRequest   | boolean                     | 共享请求，[查看详情](/tutorial/getting-started/share-request)                             |
...
alova 实例 id，用于区分不同的 alova 实例，可在[method 实例匹配器](/tutorial/advanced/method-matcher)中精准匹配指定 alova 的 method 实例。
...
| name           | string           | method 对象名称，在 [updateState](/tutorial/advanced/update-states-across-modules)、[invalidateCache](/tutorial/cache/manually-invalidate)、[setCache](/tutorial/cache/set-and-query)、以及 [fetch 函数](/tutorial/advanced/data-fetching)中可以通过名称或通配符获取对应 method 实例 |
| timeout        | number           | 请求超时时间，[查看详情](/tutorial/getting-started/timeout)                                                                                                                                                                                                                          |
...
| enableDownload | boolean          | 开启下载进度信息，[查看详情](/tutorial/getting-started/download-upload-progress)                                                                                                                                                                                                     |
| enableUpload   | boolean          | 开启上传进度信息，[查看详情](/tutorial/getting-started/download-upload-progress)                                                                                                                                                                                                     |
| transformData  | function         | 转换响应数据，[查看详情](/tutorial/getting-started/response)                                                                                                                                                                                                                         |
| shareRequest   | boolean          | 请求级共享请求开关，[查看详情](/tutorial/getting-started/share-request)                                                                                                                                                                                                              |
