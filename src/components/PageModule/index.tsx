...
export default function PageModule({ text, desc, textTransId, descTransId, children, className, align }: TitleProps) {
  return (
    <div className={className}>
      <div className={clsx('row', 'container', styles.wrapper)}>
        <div className={clsx('col col--12 margin-bottom--md flex-col', align === 'center' ? 'align-center' : '')}>
