...
We provide a [note application example](/next/tutorial/example/react/silent-submit-notes), you can enter the experience.
...
We provide a [setting page example](/next/tutorial/example/svelte/silent-submit-setting), you can enter the experience.
...
We provide a [simple list page example](/next/tutorial/example/vue/silent-submit-simple-list), you can enter the experience.
...
<!-- We provide a [preloaded example](/next/tutorial/example/vue/prefetch), you can enter the experience. -->
