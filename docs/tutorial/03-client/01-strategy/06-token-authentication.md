...
> For more information about metadata, go to [method metadata](/tutorial/getting-started/basic/method-metadata).
...
> For more information about metadata, please go to [method metadata](/tutorial/getting-started/basic/method-metadata).
