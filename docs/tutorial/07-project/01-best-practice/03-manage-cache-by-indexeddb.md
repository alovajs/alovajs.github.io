...
This feature is mainly due to alova's [Controlled Cache](/next/tutorial/cache/controlled-cache) function, which can implement custom cache management. Let's take a look at the practical steps.

<!-- Here is an [example of managed cache with IndexedDB](/next/tutorial/example/controlled-cache-by-indexeddb) -->
