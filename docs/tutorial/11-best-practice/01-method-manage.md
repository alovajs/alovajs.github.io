...
You may write the request sending code like the code snippet in [quick start](../get-started/quick-start), that is, call useRequest and create method instance with alova instance.
