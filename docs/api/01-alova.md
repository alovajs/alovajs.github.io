...
| localCache     | object                      | Local cache configuration, default GET has 5000ms cache, [View details](/next/tutorial/cache/mode)               |
...
| localCache     | LocalCacheConfig | Response cache time, [View details](/next/tutorial/cache/mode)                                                                                                                                                                                                                                                                                     |
...
| transformData  | function         | Transform response data, [View details](/next/tutorial/getting-started/basic/method)                                                                                                                                                                                                                                                               |
