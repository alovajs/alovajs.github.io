...
| shareRequest   | boolean                     | Share request, [View details](/tutorial/getting-started/share-request)                                    |
...
| name           | string           | method object name, in [updateState](/tutorial/advanced/update-states-across-modules), [invalidateCache](/tutorial/cache/manually-invalidate), [setCache](/tutorial/cache/set-and-query), and [fetch function](/tutorial/advanced/data-fetching), you can obtain the corresponding method instance by name or wildcard |
| timeout        | number           | Request timeout, [View details](/tutorial/getting-started/timeout)                                                                                                                                                                                                                                                     |
...
| enableDownload | boolean          | Enable download progress information, [View details](/tutorial/getting-started/download-upload-progress)                                                                                                                                                                                                               |
| enableUpload   | boolean          | Enable upload progress information, [View details](/tutorial/getting-started/download-upload-progress)                                                                                                                                                                                                                 |
| transformData  | function         | Transform response data, [View details](/tutorial/getting-started/response)                                                                                                                                                                                                                                            |
| shareRequest   | boolean          | Request-level sharing request switch, [View details](/tutorial/getting-started/share-request)                                                                                                                                                                                                                          |
