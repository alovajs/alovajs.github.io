...
import quickStartGET from '@site/codesandbox/01-getting-started/02-first-request/get.js?raw';
import quickStartPOST from '@site/codesandbox/01-getting-started/02-first-request/post.js?raw';
...
<Tabs items={["esModule","commonJS","deno"]}>
