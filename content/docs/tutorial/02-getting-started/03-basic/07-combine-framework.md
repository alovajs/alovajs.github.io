...
import useRequestVue from '@site/codesandbox@3/01-getting-started/07-combine-framework/vueComposition-useRequest.en.vue?raw';
import useRequestReact from '@site/codesandbox@3/01-getting-started/07-combine-framework/react-useRequest.en.jsx?raw';
import useRequestSvelte from '@site/codesandbox@3/01-getting-started/07-combine-framework/svelte-useRequest.en.svelte?raw';
import useRequestSolid from '@site/codesandbox@3/01-getting-started/07-combine-framework/solid-useRequest.en.jsx?raw';
...
<Tabs items={["vue","react/next","nuxt","svelte","solid","vue-demi"]}>
