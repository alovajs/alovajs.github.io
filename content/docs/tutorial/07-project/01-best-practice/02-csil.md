...
<Tab value="./component/profile.vue">
...
<Tab value="./component/assets.vue">
...
```
    ...
    <Tabs items={["PageRoot.jsx","./component/profile.jsx","./component/assets.jsx"]}>
    
    <Tab value="PageRoot.jsx">
...
<Tab value="./component/profile.jsx">
...
<Tab value="./component/assets.jsx">
...
```
    ...
    <Tabs items={["PageRoot.svelte","./component/profile.svelte","./component/assets.svelte"]}>
    
    <Tab value="PageRoot.svelte">
...
<Tab value="./component/profile.svelte">
...
<Tab value="./component/assets.svelte">
